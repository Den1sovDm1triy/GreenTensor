...
#Задаем радиус Линзы
k0 = int(input("Введите радиус линзы (коэффициент умножения pi): "))
#k0 = 6 * (math.pi)
...
for i in range(toch):
  for h in range(len(a)):
    ...
    ####################################
      ...
      if h == (len(a) - 1):
        # Убраны подгоночные множители /2 и *2 — они компенсировали баг c4
        # (сентинел вместо воздуха). После фикса c4 ветка последнего слоя
        # идентична промежуточной (как в 01_sphere/mie_core).
