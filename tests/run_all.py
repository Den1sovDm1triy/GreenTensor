...
def main() -> int:
    suite = [
        ...
        ("multilayer log-derivative vs BH/Kerker", mreg.test_reg1_homogeneous_bh_and_kerker),
        ("multilayer subdivision invariance", mreg.test_reg2_subdivision_invariance),
        ("energy conservation (lossless)", mreg.test_energy_conservation),
